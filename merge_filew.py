...
class FolderFileMerger:
    ...
    def process_wrong_no_replacement(self, records: List[Dict], folder_name: str):
        ...
        for record in records:
            ...
            # Create wrongmatch_merge record using record.copy() and update as per instructions
            wrong_record = record.copy()
            wrong_record.update({
                'type': 'update',
                'source': 'CM',
                'is_issue': 'Rejected',
    ...
    def process_approve_mark_products(self, records: List[Dict], folder_name: str):
        ...
        for record in records:
            approve_record = record.copy()
            approve_record.update({
                'type': 'update',
                'source': 'CM',
                'is_issue': 'Approved',
                'reject_reason': '',
